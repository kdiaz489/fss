...
class Cases extends Model{
    ...
    protected $fillable = ['sku', 'upc', 'description', 'loose_item_qty', 'basic_unit_qty', 'kit_qty', 'case_qty', 'carton_qty', 'pallet_qty', 'case_pallet_qty', 'case_shelf_qty', 'total_qty', 'location', 'lot_num'];
