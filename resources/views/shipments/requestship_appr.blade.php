               ...
               <div class="col col-lg-12 col-sm-12 col-12 bg-whitewash text-gunmetal" style="padding:2%">
                 ...
                 <div class="form-row justify-content-md-center">
                  ...
                  <div class=" form-group col-lg-3 col-12">
                    ...
                    <input type="text" class="form-control form-control-sm required" name="pallet_width" id="pallet_width" placeholder="W (inches)">
                ...
                <div class=" form-group col-lg-3 col-12">
                  ...
                  <input type="text" class="form-control form-control-sm required" name="pallet_length" id="pallet_length" placeholder="L (inches)">
                </div>

                <div class=" form-group col-lg-3 col-12">
                  <label>Height <span style="color:orange">*</span></label>
                  <input type="text" class="form-control form-control-sm required" name="pallet_height" id="pallet_height" placeholder="H (inches)">
                </div>
                 ...
                 <div class="form-row">
                   ...
                   <div class=" form-group col-lg-3 col-12">
                     ...
                     <select class="form-control form-control-sm" name="prod_stackable" id="prod_stackable" placeholder="stackable">
                      <option value="No">No</option>
                       <option value="Yes">Yes</option>
                  ...
                  <div class=" form-group col-lg-3 col-12">
                    ...
                    <select class="form-control form-control-sm required" name="load_strap" id="load_strap" placeholder="stackable">
                      <option value="No">No</option>
                      <option value="Yes">Yes</option>
                 ...
                 <div class=" form-group col-lg-3 col-12">
                   ...
                   <select class="form-control form-control-sm required" name="load_blck" id="load_blck" placeholder="stackable">
                    <option value="No">No</option>
                     <option value="Yes">Yes</option>
