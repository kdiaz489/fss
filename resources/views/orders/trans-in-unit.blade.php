...
<div class="container mt-5">
    ...
    <form action="/transinunit" method="POST">
    
    <div class="form-row justify-content-center mb-4">
        <div class="col-md-3">
            <label for="transin_unit_name">Order Name</label>
            <input type="text" name="transin_unit_name" class="form-control" placeholder="Name">
            <div style="font-weight: 700; color:red">{{$errors->first('transin_unit_name')}}</div>
        </div>

        <div class="col-md-3">
            <label for="transin_unit_barcode">Barcode</label>
            <input type="text" name="transin_unit_barcode" class="form-control" placeholder="Barcode">
    ...
    <div class="form-row justify-content-center mb-4">
        <div class="col-md-3">
            ...
            <textarea name="transin_unit_desc" id="" cols="30" rows="1" class="form-control" placeholder="Description Here"></textarea>
        ...
        <div class="col-md-3">
            <label for="transin_unit_qty">Unit Quantity</label>
            <input type="text" name="transin_unit_qty" class="form-control" placeholder="Units Qty">
